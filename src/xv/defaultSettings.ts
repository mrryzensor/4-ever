...
export const DEFAULT_XV_SETTINGS: WeddingSettings = {
  ...
  heroPadrinosTitle: 'Mis Padrinos',
  heroPadrinos: '',
  ...
  showGuestbook: true,
  showHotels: false,
  hotelsTitle: 'Hospedaje recomendado',
  hotelRecommendations: '[]',
  landingSectionOrder: '["invitation","gallery","video","hotels","guestbook","rsvp"]',
  detailSectionOrder: '["ceremony","reception","rsvp","itinerary","gifts","dress-code","tips"]',
