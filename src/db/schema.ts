...
export const weddingSettings = pgTable('wedding_settings', {
  ...
  ceremonyArrivalVideoUrl: text('ceremony_arrival_video_url').default(''),
  ...
  receptionSameAsCeremony: boolean('reception_same_as_ceremony').default(false),
  ...
  receptionArrivalVideoUrl: text('reception_arrival_video_url').default(''),
  ...
  typographyTitleScale: integer('typography_title_scale').default(100),
  typographyHeadingScale: integer('typography_heading_scale').default(100),
  typographyBodyScale: integer('typography_body_scale').default(100),
  typographySubtitleScale: integer('typography_subtitle_scale').default(100),
  ...
  showBankAccountsWhenCollapsed: boolean('show_bank_accounts_when_collapsed').default(true),
