...
export const weddingSettings = pgTable('wedding_settings', {
  ...
  heroShowPadrinos: boolean('hero_show_padrinos').default(false),
  heroPadrinosTitle: text('hero_padrinos_title').default('Nuestros Padrinos'),
  heroPadrinos: text('hero_padrinos').default(''),
  heroShowBrideParents: boolean('hero_show_bride_parents').default(false),
  heroBrideParentsTitle: text('hero_bride_parents_title').default('Padres de la Novia'),
  heroBrideParents: text('hero_bride_parents').default(''),
  heroShowGroomParents: boolean('hero_show_groom_parents').default(false),
  heroGroomParentsTitle: text('hero_groom_parents_title').default('Padres del Novio'),
  heroGroomParents: text('hero_groom_parents').default(''),
  heroShowWitnesses: boolean('hero_show_witnesses').default(false),
  heroWitnessesTitle: text('hero_witnesses_title').default('Testigos'),
  heroWitnesses: text('hero_witnesses').default(''),
  ...
  countdownLayout: text('countdown_layout').default('circle'),
  countdownTitle: text('countdown_title').default('Faltan'),
  countdownPlacement: text('countdown_placement').default('transition'),
  showCountdownGuestsBadge: boolean('show_countdown_guests_badge').default(true),
  colorPaletteStyle: text('color_palette_style').default('auto'),
  customAccentColor: text('custom_accent_color').default(''),
  customBgColor: text('custom_bg_color').default(''),
  fontPairStyle: text('font_pair_style').default('auto'),
  ...
  transitionEffect: text('transition_effect').default('wave'),
  heroIconStyle: text('hero_icon_style').default('auto'),
  heroEmblemColor: text('hero_emblem_color').default(''),
  heroEmblemGlow: integer('hero_emblem_glow').default(72),
  heroEmblemSparkle: integer('hero_emblem_sparkle').default(78),
  heroEmblemScale: integer('hero_emblem_scale').default(100),
  ambientParticleStyle: text('ambient_particle_style').default('auto'),
  sealStyle: text('seal_style').default('auto'),
  ...
  showGiftRegistry: boolean('show_gift_registry').default(false),
  ...
  hotelsTitle: text('hotels_title').default('Hospedaje recomendado'),
  ...
  detailSectionOrder: text('detail_section_order').default('["ceremony","reception","rsvp","itinerary","gifts","dress-code","tips"]'),
  ...
  bankClabe: text('bank_clabe').default(''),
  bankCardNumber: text('bank_card_number').default(''),
  bankConcept: text('bank_concept').default('Evento Sofía & Alejandro'),
  bankCurrency: text('bank_currency').default('MXN'),
  bankAccounts: text('bank_accounts').default('[]'),
  enableBankTransfer: boolean('enable_bank_transfer').default(false),
  enableStoreRegistry: boolean('enable_store_registry').default(false),
