  ...
  return (
    <header className="sticky top-0 z-50 w-full px-2 sm:px-4 lg:px-8 py-1.5 sm:py-2 bg-stone-950/95 backdrop-blur-xl border-b border-white/10 shadow-2xl transition-all select-none">
      <div className="w-full flex items-center justify-between gap-1.5 sm:gap-3">
        ...
        {/* Left: Back button & Demo Badge (Responsive & Never Clipped) */}
        <div className="flex items-center gap-1.5 sm:gap-2 shrink-0">
          ...
          {/* Couple Badge on tablet/desktop */}
          <div className="hidden sm:flex items-center gap-1 shrink-0">
            <span className="px-2.5 py-0.5 sm:py-1 rounded-full bg-amber-400/20 border border-amber-400/30 text-amber-300 font-mono text-[10px] sm:text-[11px] uppercase font-bold tracking-wider flex items-center gap-1 shrink-0">
        ...
        <div className="relative flex-1 min-w-0 mx-1 sm:mx-2 max-w-[240px] sm:max-w-xs md:max-w-sm flex justify-center">
          <button
            ...
            className="w-full px-2.5 sm:px-3.5 py-1.5 rounded-full bg-stone-900/90 hover:bg-stone-800 border border-amber-400/35 hover:border-amber-400/70 text-white transition-all flex items-center justify-between gap-1.5 sm:gap-2 shadow-inner cursor-pointer min-w-0"
          ...
          >
            ...
            <div className="flex items-center gap-1 shrink-0 text-stone-400 ml-1">
              ...
              <ChevronDown className={`w-3.5 h-3.5 transition-transform duration-200 shrink-0 ${isMenuOpen ? 'rotate-180 text-amber-400' : ''}`} />
            </div>
          </button>
