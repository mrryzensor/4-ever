...
export const LiveInvitationCanvas: React.FC<LiveInvitationCanvasProps> = ({
  ...
  // The admin layout keeps desktop and mobile canvases in the DOM for CSS
  // responsiveness. Only the canvas with real dimensions may mount an iframe;
  // otherwise the hidden preview can load and play its own audio in parallel.
  useEffect(() => {
