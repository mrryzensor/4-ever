  ...
  try {
    ...
    try {
      ...
      await client.query(`
        ...
        ALTER TABLE wedding_settings ADD COLUMN IF NOT EXISTS gallery_drive_photo_ids TEXT DEFAULT '[]';
        ...
        ALTER TABLE wedding_settings ADD COLUMN IF NOT EXISTS detail_section_order TEXT DEFAULT '["ceremony","reception","rsvp","itinerary","gifts","dress-code","tips"]';
        ALTER TABLE wedding_settings ALTER COLUMN detail_section_order SET DEFAULT '["ceremony","reception","rsvp","itinerary","gifts","dress-code","tips"]';
