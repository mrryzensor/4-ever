      ...
      >
        ...
        {outfitType === 'long-gown' && (
          <g id="outfit-long-gown">
            ...
            {/* Hand-finished neckline and corset seams add refined detail to the dress. */}
            ...
            <g id="evening-clutch">
              ...
              <path d="M150 178 Q156 177 160 181 L164 187 Q162 191 158 190 L151 185 Z" fill="url(#woman-skin-tone)" stroke="#D69F8B" strokeWidth="0.7" />
