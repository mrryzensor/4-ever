  ...
  weddings: [
    {
      ...
      heroShowPadrinos: false,
      heroPadrinosTitle: 'Nuestros Padrinos',
      heroPadrinos: '',
      heroShowBrideParents: false,
      heroBrideParentsTitle: 'Padres de la Novia',
      heroBrideParents: '',
      heroShowGroomParents: false,
      heroGroomParentsTitle: 'Padres del Novio',
      heroGroomParents: '',
      heroShowWitnesses: false,
      heroWitnessesTitle: 'Testigos',
      heroWitnesses: '',
      ...
      customBgColor: '',
      fontPairStyle: 'auto',
      typographyTitleScale: 100,
      typographyHeadingScale: 100,
      typographyBodyScale: 100,
      typographySubtitleScale: 100,
...
const DEMO_XV_DB_FIELDS = [
  ...
  'heroIconStyle',
  'audioUrl', 'audioTitle', 'audioAutoplay', 'audioPlaylist', 'welcomeMessage', 'welcomeSubtitle',
