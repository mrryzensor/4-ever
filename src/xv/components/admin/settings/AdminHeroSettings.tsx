          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            ...
            <div className="sm:col-span-2 p-4 bg-[#FAF9F0] rounded-2xl border border-[#E5E2D0] space-y-3">
              ...
              <div className="flex items-center justify-between gap-2">
                <div className="flex items-center gap-2.5">
                  ...
                  <div>
                    ...
                    <span className="text-[10px] text-[#7D8C7A]">
                      Por defecto desactivado • Despliega los nombres con distintivo ornamental dorado bajo la quinceañera
                    </span>
                  </div>
                </div>
              ...
              {settings.heroShowPadrinos && (
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 pt-2 border-t border-[#E5E2D0]/60 animate-fadeIn">
                  <div>
                    <label className="text-[11px] font-semibold text-[#5A5A40] block mb-1">
                      Título / Distinción:
                    </label>
                    <input
                      ...
                      onChange={(e) =>
                        onChange({ heroPadrinosTitle: e.target.value })
                      }
                      placeholder="Mis Padrinos"
                      className="w-full bg-white border border-[#E5E2D0] rounded-xl px-3 py-2 text-xs text-[#3D3D3D] focus:outline-none focus:border-[#5A5A40] font-serif"
                    />
                    <span className="text-[9px] text-[#7D8C7A] mt-0.5 block">
                  ...
                  <div className="sm:col-span-2">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        onChange({ heroPadrinos: e.target.value })
                      }
                      placeholder="Ej. Roberto Gómez & Carmen Morales"
                      className="w-full bg-white border border-[#E5E2D0] rounded-xl px-3 py-2 text-xs text-[#3D3D3D] focus:outline-none focus:border-[#5A5A40] font-serif"
                    />
                    <span className="text-[9px] text-[#7D8C7A] mt-0.5 block">
                      Aparecerán destacados en la vista previa superior y en la invitación en vivo
                    </span>
                  </div>
                </div>
              )}
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-[#7D8C7A]">
                Contador dinámico situado sobre la ola ondulada de transición entre la portada y la invitación de Mis XV.
              </p>
            </div>
          </div>
          <label className="relative inline-flex items-center cursor-pointer shrink-0">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  placeholder="Ej. Faltan, Falta, Mis XV Años, Mi Gran Noche"
            ...
            <div>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-2.5">
                {[
                  ...
                  { id: 'romantic-floral', name: 'Rosas & Tiara', desc: 'Ramillete floral y blush' },
