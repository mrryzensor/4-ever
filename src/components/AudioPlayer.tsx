...
export const AudioPlayer: React.FC<AudioPlayerProps> = ({
  ...
  // All start requests (initial autoplay, first user gesture, play button and
  // playlist advance) share the same audio element and in-flight play request.
  const requestPlayback = (allowMutedAutoplayFallback = false) => {
    ...
    try {
      // Call play synchronously so a user gesture remains valid in the browser.
